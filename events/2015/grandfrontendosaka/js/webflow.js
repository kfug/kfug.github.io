...
Webflow.require('ix').init([
  ...
  {"slug":"scale-on-scroll","name":"Scale on Scroll","value":{"style":{"opacity":0,"scale":0.01},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"wait":1300,"transition":"transform 600ms ease 0ms, opacity 600ms ease 0ms","scale":1}],"stepsB":[]}]}}
]);
